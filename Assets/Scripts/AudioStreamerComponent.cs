...
namespace StartingOver.UniVoiceLAN {
	/// <summary>
	...
	/// </summary>
	public class AudioStreamerComponent : MonoBehaviour {
		...
		/// <returns></returns>
		public static AudioStreamerComponent New(GameObject origin, AudioBuffer buffer, AudioSource source) {
			var cted = origin.AddComponent<AudioStreamerComponent>();
